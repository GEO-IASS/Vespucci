...
void QCPColorGradient::loadPreset(GradientPreset preset)
{
  ...
  switch (preset)
  {
    ...
    case gpHues:
      ...
      break;
    //Sequential ColorBrewer2 schemes, added by dpf
    case cbBuGn:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(247,252,253));
      setColorStopAt(7.0/8.0, QColor(229,245,249));
      setColorStopAt(6.0/8.0, QColor(204,236,230));
      setColorStopAt(5.0/8.0, QColor(153,216,201));
      setColorStopAt(4.0/8.0, QColor(102,194,164));
      setColorStopAt(3.0/8.0, QColor(65,174,118));
      setColorStopAt(2.0/8.0, QColor(35,139,69));
      setColorStopAt(1.0/8.0, QColor(0,109,44));
      setColorStopAt(0, QColor(0,68,27));
      break;
    case cbBuPu:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(247,252,253));
      setColorStopAt(7.0/8.0, QColor(224,236,244));
      setColorStopAt(6.0/8.0, QColor(191,211,230));
      setColorStopAt(5.0/8.0, QColor(158,188,218));
      setColorStopAt(4.0/8.0, QColor(140,150,198));
      setColorStopAt(3.0/8.0, QColor(140,107,177));
      setColorStopAt(2.0/8.0, QColor(136,65,157));
      setColorStopAt(1.0/8.0, QColor(129,15,124));
      setColorStopAt(0, QColor(77,0,75));
      break;
    case cbGnBu:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(247,252,240));
      setColorStopAt(7.0/8.0, QColor(224,243,219));
      setColorStopAt(6.0/8.0, QColor(204,235,197));
      setColorStopAt(5.0/8.0, QColor(168,221,181));
      setColorStopAt(4.0/8.0, QColor(123,204,196));
      setColorStopAt(3.0/8.0, QColor(78,179,211));
      setColorStopAt(2.0/8.0, QColor(43,140,190));
      setColorStopAt(1.0/8.0, QColor(8,104,172));
      setColorStopAt(0, QColor(8,64,129));
      break;
    case cbOrRd:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(255,247,236));
      setColorStopAt(7.0/8.0, QColor(254,232,200));
      setColorStopAt(6.0/8.0, QColor(253,212,158));
      setColorStopAt(5.0/8.0, QColor(253,187,132));
      setColorStopAt(4.0/8.0, QColor(252,141,89));
      setColorStopAt(3.0/8.0, QColor(239,101,72));
      setColorStopAt(2.0/8.0, QColor(215,48,31));
      setColorStopAt(1.0/8.0, QColor(179,0,0));
      setColorStopAt(0, QColor(127,0,0));
      break;
    case cbPuBu:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(255,247,251));
      setColorStopAt(7.0/8.0, QColor(236,231,242));
      setColorStopAt(6.0/8.0, QColor(208,209,230));
      setColorStopAt(5.0/8.0, QColor(166,189,219));
      setColorStopAt(4.0/8.0, QColor(116,169,207));
      setColorStopAt(3.0/8.0, QColor(54,144,192));
      setColorStopAt(2.0/8.0, QColor(5,112,176));
      setColorStopAt(1.0/8.0, QColor(4,90,141));
      setColorStopAt(0, QColor(2,56,88));
      break;
    case cbPuBuGn:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(255,247,251));
      setColorStopAt(7.0/8.0, QColor(236,226,240));
      setColorStopAt(6.0/8.0, QColor(208,209,230));
      setColorStopAt(5.0/8.0, QColor(166,189,219));
      setColorStopAt(4.0/8.0, QColor(103,169,207));
      setColorStopAt(3.0/8.0, QColor(54,144,192));
      setColorStopAt(2.0/8.0, QColor(2,129,138));
      setColorStopAt(1.0/8.0, QColor(1,108,89));
      setColorStopAt(0, QColor(1,70,54));
      break;
    case cbPuRd:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(247,244,249));
      setColorStopAt(7.0/8.0, QColor(231,225,239));
      setColorStopAt(6.0/8.0, QColor(212,185,218));
      setColorStopAt(5.0/8.0, QColor(201,148,199));
      setColorStopAt(4.0/8.0, QColor(223,101,176));
      setColorStopAt(3.0/8.0, QColor(231,41,138));
      setColorStopAt(2.0/8.0, QColor(206,18,86));
      setColorStopAt(1.0/8.0, QColor(152,0,67));
      setColorStopAt(0, QColor(103,0,31));
      break;
    case cbRdPu:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(255,247,243));
      setColorStopAt(7.0/8.0, QColor(253,224,221));
      setColorStopAt(6.0/8.0, QColor(252,197,192));
      setColorStopAt(5.0/8.0, QColor(250,159,181));
      setColorStopAt(4.0/8.0, QColor(247,104,161));
      setColorStopAt(3.0/8.0, QColor(221,52,151));
      setColorStopAt(2.0/8.0, QColor(174,1,126));
      setColorStopAt(1.0/8.0, QColor(122,1,119));
      setColorStopAt(0, QColor(73,0,106));
      break;
    case cbYlGn:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(255,255,229));
      setColorStopAt(7.0/8.0, QColor(247,252,185));
      setColorStopAt(6.0/8.0, QColor(217,240,163));
      setColorStopAt(5.0/8.0, QColor(173,221,142));
      setColorStopAt(4.0/8.0, QColor(120,198,121));
      setColorStopAt(3.0/8.0, QColor(65,171,93));
      setColorStopAt(2.0/8.0, QColor(35,132,67));
      setColorStopAt(1.0/8.0, QColor(0,104,55));
      setColorStopAt(0, QColor(0,69,41));
      break;
    case cbYlGnBu:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(255,255,217));
      setColorStopAt(7.0/8.0, QColor(237,248,177));
      setColorStopAt(6.0/8.0, QColor(199,233,180));
      setColorStopAt(5.0/8.0, QColor(127,205,187));
      setColorStopAt(4.0/8.0, QColor(65,182,196));
      setColorStopAt(3.0/8.0, QColor(29,145,192));
      setColorStopAt(2.0/8.0, QColor(34,94,168));
      setColorStopAt(1.0/8.0, QColor(37,52,148));
      setColorStopAt(0, QColor(8,29,88));
      break;
    case cbYlOrBr:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(255,255,229));
      setColorStopAt(7.0/8.0, QColor(255,247,188));
      setColorStopAt(6.0/8.0, QColor(254,227,145));
      setColorStopAt(5.0/8.0, QColor(254,196,79));
      setColorStopAt(4.0/8.0, QColor(254,153,41));
      setColorStopAt(3.0/8.0, QColor(236,112,20));
      setColorStopAt(2.0/8.0, QColor(204,76,2));
      setColorStopAt(1.0/8.0, QColor(153,52,4));
      setColorStopAt(0, QColor(102,37,6));
      break;

    case cbYlOrRd:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(255,255,204));
      setColorStopAt(7.0/8.0, QColor(255,237,160));
      setColorStopAt(6.0/8.0, QColor(254,217,118));
      setColorStopAt(5.0/8.0, QColor(254,178,76));
      setColorStopAt(4.0/8.0, QColor(253,141,60));
      setColorStopAt(3.0/8.0, QColor(252,78,42));
      setColorStopAt(2.0/8.0, QColor(227,26,28));
      setColorStopAt(1.0/8.0, QColor(189,0,38));
      setColorStopAt(0, QColor(128,0,38));
      break;
    case cbBlues:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(247,251,255));
      setColorStopAt(7.0/8.0, QColor(222,235,247));
      setColorStopAt(6.0/8.0, QColor(198,219,239));
      setColorStopAt(5.0/8.0, QColor(158,202,225));
      setColorStopAt(4.0/8.0, QColor(107,174,214));
      setColorStopAt(3.0/8.0, QColor(66,146,198));
      setColorStopAt(2.0/8.0, QColor(33,113,181));
      setColorStopAt(1.0/8.0, QColor(8,81,156));
      setColorStopAt(0, QColor(8,48,107));
      break;
    case cbGreens:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(247,252,245));
      setColorStopAt(7.0/8.0, QColor(229,245,224));
      setColorStopAt(6.0/8.0, QColor(199,233,192));
      setColorStopAt(5.0/8.0, QColor(161,217,155));
      setColorStopAt(4.0/8.0, QColor(116,196,118));
      setColorStopAt(3.0/8.0, QColor(65,171,93));
      setColorStopAt(2.0/8.0, QColor(35,139,69));
      setColorStopAt(1.0/8.0, QColor(0,109,44));
      setColorStopAt(0, QColor(0,68,27));
    ...
    case cbGreys:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(255,255,255));
      setColorStopAt(7.0/8.0, QColor(240,240,240));
      setColorStopAt(6.0/8.0, QColor(217,217,217));
      setColorStopAt(5.0/8.0, QColor(189,189,189));
      setColorStopAt(4.0/8.0, QColor(150,150,150));
      setColorStopAt(3.0/8.0, QColor(115,115,115));
      setColorStopAt(2.0/8.0, QColor(82,82,82));
      setColorStopAt(1.0/8.0, QColor(37,37,37));
      setColorStopAt(0, QColor(0,0,0));
      break;
    case cbOranges:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(255,245,235));
      setColorStopAt(7.0/8.0, QColor(254,230,206));
      setColorStopAt(6.0/8.0, QColor(253,208,162));
      setColorStopAt(5.0/8.0, QColor(253,174,107));
      setColorStopAt(4.0/8.0, QColor(253,141,60));
      setColorStopAt(3.0/8.0, QColor(241,105,19));
      setColorStopAt(2.0/8.0, QColor(217,72,1));
      setColorStopAt(1.0/8.0, QColor(166,54,3));
      setColorStopAt(0, QColor(127,39,4));
      break;
    case cbPurples:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(252,251,253));
      setColorStopAt(7.0/8.0, QColor(239,237,245));
      setColorStopAt(6.0/8.0, QColor(218,218,235));
      setColorStopAt(5.0/8.0, QColor(188,189,220));
      setColorStopAt(4.0/8.0, QColor(158,154,200));
      setColorStopAt(3.0/8.0, QColor(128,125,186));
      setColorStopAt(2.0/8.0, QColor(106,81,163));
      setColorStopAt(1.0/8.0, QColor(84,39,143));
      setColorStopAt(0, QColor(63,0,125));
      break;
    case cbReds:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(255,245,240));
      setColorStopAt(7.0/8.0, QColor(254,224,210));
      setColorStopAt(6.0/8.0, QColor(252,187,161));
      setColorStopAt(5.0/8.0, QColor(252,146,114));
      setColorStopAt(4.0/8.0, QColor(251,106,74));
      setColorStopAt(3.0/8.0, QColor(239,59,44));
      setColorStopAt(2.0/8.0, QColor(203,24,29));
      setColorStopAt(1.0/8.0, QColor(165,15,21));
      setColorStopAt(0, QColor(103,0,13));
      break;
    case cbBrBG:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(84,48,5));
      setColorStopAt(9.0/10.0, QColor(140,81,10));
      setColorStopAt(8.0/10.0, QColor(191,129,45));
      setColorStopAt(7.0/10.0, QColor(223,194,125));
      setColorStopAt(6.0/10.0, QColor(246,232,195));
      setColorStopAt(5.0/10.0, QColor(245,245,245));
      setColorStopAt(4.0/10.0, QColor(199,234,229));
      setColorStopAt(3.0/10.0, QColor(128,205,193));
      setColorStopAt(2.0/10.0, QColor(53,151,143));
      setColorStopAt(1.0/10.0, QColor(1,102,94));
      setColorStopAt(0, QColor(0,60,48));
      break;
    case cbPiYG:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(142,1,82));
      setColorStopAt(9.0/10.0, QColor(197,27,125));
      setColorStopAt(8.0/10.0, QColor(222,119,174));
      setColorStopAt(7.0/10.0, QColor(241,182,218));
      setColorStopAt(6.0/10.0, QColor(253,224,239));
      setColorStopAt(5.0/10.0, QColor(247,247,247));
      setColorStopAt(4.0/10.0, QColor(230,245,208));
      setColorStopAt(3.0/10.0, QColor(184,225,134));
      setColorStopAt(2.0/10.0, QColor(127,188,65));
      setColorStopAt(1.0/10.0, QColor(77,146,33));
      setColorStopAt(0, QColor(39,100,25));
      break;
    case cbPRGn:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(64,0,75));
      setColorStopAt(9.0/10.0, QColor(118,42,131));
      setColorStopAt(8.0/10.0, QColor(153,112,171));
      setColorStopAt(7.0/10.0, QColor(194,165,207));
      setColorStopAt(6.0/10.0, QColor(231,212,232));
      setColorStopAt(5.0/10.0, QColor(247,247,247));
      setColorStopAt(4.0/10.0, QColor(217,240,211));
      setColorStopAt(3.0/10.0, QColor(166,219,160));
      setColorStopAt(2.0/10.0, QColor(90,174,97));
      setColorStopAt(1.0/10.0, QColor(27,120,55));
      setColorStopAt(0, QColor(0,68,27));
      break;
    case cbPuOr:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(127,59,8));
      setColorStopAt(9.0/10.0, QColor(179,88,6));
      setColorStopAt(8.0/10.0, QColor(224,130,20));
      setColorStopAt(7.0/10.0, QColor(253,184,99));
      setColorStopAt(6.0/10.0, QColor(254,224,182));
      setColorStopAt(5.0/10.0, QColor(247,247,247));
      setColorStopAt(4.0/10.0, QColor(216,218,235));
      setColorStopAt(3.0/10.0, QColor(178,171,210));
      setColorStopAt(2.0/10.0, QColor(128,115,172));
      setColorStopAt(1.0/10.0, QColor(84,39,136));
      setColorStopAt(0, QColor(45,0,75));
      break;
    case cbRdBu:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(103,0,31));
      setColorStopAt(9.0/10.0, QColor(178,24,43));
      setColorStopAt(8.0/10.0, QColor(214,96,77));
      setColorStopAt(7.0/10.0, QColor(244,165,130));
      setColorStopAt(6.0/10.0, QColor(253,219,199));
      setColorStopAt(5.0/10.0, QColor(247,247,247));
      setColorStopAt(4.0/10.0, QColor(209,229,240));
      setColorStopAt(3.0/10.0, QColor(146,197,222));
      setColorStopAt(2.0/10.0, QColor(67,147,195));
      setColorStopAt(1.0/10.0, QColor(33,102,172));
      setColorStopAt(0, QColor(5,48,97));
      break;
    case cbRdGy:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(103,0,31));
      ...
      setColorStopAt(7.0/10.0, QColor(244,165,130));
      setColorStopAt(6.0/10.0, QColor(253,219,199));
      setColorStopAt(5.0/10.0, QColor(255,255,255));
      setColorStopAt(4.0/10.0, QColor(224,224,224));
      setColorStopAt(3.0/10.0, QColor(186,186,186));
      setColorStopAt(2.0/10.0, QColor(135,135,135));
      setColorStopAt(1.0/10.0, QColor(77,77,77));
      setColorStopAt(0, QColor(26,26,26));
      break;
    case cbRdYlBu:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(165,0,38));
      setColorStopAt(9.0/10.0, QColor(215,48,39));
      setColorStopAt(8.0/10.0, QColor(244,109,67));
      setColorStopAt(7.0/10.0, QColor(253,174,97));
      setColorStopAt(6.0/10.0, QColor(254,224,144));
      setColorStopAt(5.0/10.0, QColor(255,255,191));
      setColorStopAt(4.0/10.0, QColor(224,243,248));
      setColorStopAt(3.0/10.0, QColor(171,217,233));
      setColorStopAt(2.0/10.0, QColor(116,173,209));
      setColorStopAt(1.0/10.0, QColor(69,117,180));
      setColorStopAt(0, QColor(49,54,149));
      break;
    case cbRdYlGn:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(165,0,38));
      ...
      setColorStopAt(8.0/10.0, QColor(244,109,67));
      setColorStopAt(7.0/10.0, QColor(253,174,97));
      setColorStopAt(6.0/10.0, QColor(254,224,139));
      setColorStopAt(5.0/10.0, QColor(255,255,191));
      setColorStopAt(4.0/10.0, QColor(217,239,139));
      setColorStopAt(3.0/10.0, QColor(166,217,106));
      setColorStopAt(2.0/10.0, QColor(102,189,99));
      setColorStopAt(1.0/10.0, QColor(26,152,80));
      setColorStopAt(0, QColor(0,104,55));
      break;
    case cbSpectral:
      setColorInterpolation(ciHSV);
      setColorStopAt(1, QColor(158,1,66));
      setColorStopAt(9.0/10.0, QColor(213,62,79));
      setColorStopAt(8.0/10.0, QColor(244,109,67));
      setColorStopAt(7.0/10.0, QColor(253,174,97));
      setColorStopAt(6.0/10.0, QColor(254,224,139));
      setColorStopAt(5.0/10.0, QColor(255,255,191));
      setColorStopAt(4.0/10.0, QColor(230,245,152));
      setColorStopAt(3.0/10.0, QColor(171,221,164));
      setColorStopAt(2.0/10.0, QColor(102,194,165));
    ...
    case cbCluster:
      ...
      setColorStopAt(5.0/8.0, QColor(152,78,163));
      setColorStopAt(4.0/8.0, QColor(255,127,0));
      setColorStopAt(3.0/8.0, QColor(255,255,51));
      setColorStopAt(2.0/8.0, QColor(166,86,40));
      setColorStopAt(1.0/8.0, QColor(247,129,191));
      setColorStopAt(0, QColor(153,153,153));
      break;
    case vSpectral:
      setColorInterpolation(ciHSV);
      setColorStopAt(64.0/64.0, QColor(0,0,0));
      setColorStopAt(63.0/64.0, QColor(0,0,36));
      setColorStopAt(62.0/64.0, QColor(0,0,73));
      setColorStopAt(61.0/64.0, QColor(0,0,109));
      setColorStopAt(60.0/64.0, QColor(0,0,146));
      setColorStopAt(59.0/64.0, QColor(0,0,182));
      setColorStopAt(58.0/64.0, QColor(0,0,219));
      setColorStopAt(57.0/64.0, QColor(0,0,255));
      setColorStopAt(56.0/64.0, QColor(0,16,255));
      setColorStopAt(55.0/64.0, QColor(0,32,255));
      setColorStopAt(54.0/64.0, QColor(0,48,255));
      setColorStopAt(53.0/64.0, QColor(0,64,255));
      setColorStopAt(52.0/64.0, QColor(0,80,255));
      setColorStopAt(51.0/64.0, QColor(0,96,255));
      setColorStopAt(50.0/64.0, QColor(0,111,255));
      setColorStopAt(49.0/64.0, QColor(0,128,255));
      setColorStopAt(48.0/64.0, QColor(0,143,255));
      setColorStopAt(47.0/64.0, QColor(0,159,255));
      setColorStopAt(46.0/64.0, QColor(0,175,255));
      setColorStopAt(45.0/64.0, QColor(0,191,255));
      setColorStopAt(44.0/64.0, QColor(0,207,255));
      setColorStopAt(43.0/64.0, QColor(0,223,255));
      setColorStopAt(42.0/64.0, QColor(0,239,255));
      setColorStopAt(41.0/64.0, QColor(0,255,255));
      setColorStopAt(40.0/64.0, QColor(16,255,239));
      setColorStopAt(39.0/64.0, QColor(32,255,223));
      setColorStopAt(38.0/64.0, QColor(48,255,207));
      setColorStopAt(37.0/64.0, QColor(64,255,191));
      setColorStopAt(36.0/64.0, QColor(80,255,175));
      setColorStopAt(35.0/64.0, QColor(96,255,159));
      setColorStopAt(34.0/64.0, QColor(111,255,143));
      setColorStopAt(33.0/64.0, QColor(128,255,128));
      setColorStopAt(32.0/64.0, QColor(143,255,111));
      setColorStopAt(31.0/64.0, QColor(159,255,96));
      setColorStopAt(30.0/64.0, QColor(175,255,80));
      setColorStopAt(29.0/64.0, QColor(191,255,64));
      setColorStopAt(28.0/64.0, QColor(207,255,48));
      setColorStopAt(27.0/64.0, QColor(223,255,32));
      setColorStopAt(26.0/64.0, QColor(239,255,16));
      setColorStopAt(25.0/64.0, QColor(255,255,0));
      setColorStopAt(24.0/64.0, QColor(255,239,0));
      setColorStopAt(23.0/64.0, QColor(255,223,0));
      setColorStopAt(22.0/64.0, QColor(255,207,0));
      setColorStopAt(21.0/64.0, QColor(255,191,0));
      setColorStopAt(20.0/64.0, QColor(255,175,0));
      setColorStopAt(19.0/64.0, QColor(255,159,0));
      setColorStopAt(18.0/64.0, QColor(255,143,0));
      setColorStopAt(17.0/64.0, QColor(255,128,0));
      setColorStopAt(16.0/64.0, QColor(255,111,0));
      setColorStopAt(15.0/64.0, QColor(255,96,0));
      setColorStopAt(14.0/64.0, QColor(255,80,0));
      setColorStopAt(13.0/64.0, QColor(255,64,0));
      setColorStopAt(12.0/64.0, QColor(255,48,0));
      setColorStopAt(11.0/64.0, QColor(255,32,0));
      setColorStopAt(10.0/64.0, QColor(255,16,0));
      setColorStopAt(9.0/64.0, QColor(255,0,0));
      setColorStopAt(8.0/64.0, QColor(255,32,32));
      setColorStopAt(7.0/64.0, QColor(255,32,32));
      setColorStopAt(6.0/64.0, QColor(255,64,64));
      setColorStopAt(5.0/64.0, QColor(255,96,96));
      setColorStopAt(4.0/64.0, QColor(255,128,128));
      setColorStopAt(3.0/64.0, QColor(255,159,159));
      setColorStopAt(2.0/64.0, QColor(255,191,191));
      setColorStopAt(1.0/64.0, QColor(255,223,223));
      setColorStopAt(0.0/64.0, QColor(255,255,255));
      break;
